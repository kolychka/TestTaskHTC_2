...
const tvChannelsImg = img => "<img src=\"images/channels-logotypes/" + img + "\" alt=\"\">";

const tvChannelsTVProgrammItem = programm => `<section class="tv-channels__tv-programm_margin_b">
